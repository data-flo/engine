...
tap.test("given two dates, should return difference in quarters", async (t) => {
  const expected = 2;
  const actual = difference(new Date(2014, 6, 2), new Date(2013, 11, 31), "quarters");
  t.equal(actual, expected);
});

tap.test("given two dates, should return difference in months", async (t) => {
  const expected = 7;
...
tap.test("given two dates, should return difference in days", async (t) => {
  const expected = 92;
  const actual = difference(new Date(2020, 5, 1), new Date(2020, 2, 1), "days");
  t.equal(actual, expected);
});

tap.test("given two dates, should return difference in hours", async (t) => {
  const expected = 12;
  const actual = difference(new Date(2014, 6, 2, 19, 0), new Date(2014, 6, 2, 6, 50), "hours");
  t.equal(actual, expected);
});

tap.test("given two dates, should return difference in minutes", async (t) => {
  const expected = 12;
  const actual = difference(new Date(2014, 6, 2, 12, 20, 0), new Date(2014, 6, 2, 12, 7, 59), "minutes");
  t.equal(actual, expected);
});

tap.test("given two dates, should return difference in seconds", async (t) => {
  const expected = 12;
  const actual = difference(new Date(2014, 6, 2, 12, 30, 20, 0), new Date(2014, 6, 2, 12, 30, 7, 999), "seconds");
  t.equal(actual, expected);
});

tap.test("given two dates, should return difference in milliseconds", async (t) => {
  const expected = 1100;
