...
tap.test("import-from-google-sheet adaptor", async () => {

  tap.test("given a google-sheet, it should return a datatable", async () => {
  ...
  tap.test("given a range, it should return a datatable", async () => {
    const output = await runAdaptor(
      adaptor,
      {
        "url": "https://docs.google.com/spreadsheets/d/1hTK7EuBfStSwzF3NZpLignw6m45lmFjHooDX0r_3Tfc/edit#gid=0",
