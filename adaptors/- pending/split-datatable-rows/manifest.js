  ...
  "output": [
    {
      "name": "data",
      "type": "datatable",
      "description": "A datatable with the rows that match the testing expression; otherwise, an empty datatable is returned."
    },
    {
      "name": "complementary",
      "type": "datatable",
      "description": "A datatable with the rows that *did not match* the testing expression."
    }
  ]
}