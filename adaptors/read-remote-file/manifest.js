module.exports = {
  "description": "Retrieves a remote file from a remote network server.",
  ...
  "input": [
    ...
    },
    {
      ...
      "type": "text",
      "default": null,
      "description": "Input file encoding. Supported encodings are: `ascii`, `base64`, `binary`, `hex`, `ucs2`, `utf8`, or `latin1`."
    }
  ],
  "output": [
    {
