module.exports = {
  "description": "Updates a project on a Microreact server.",
  "category": "Data Destinations",
  "input": [
    {
      "name": "project",
      "type": "text",
      "description": "The ID (e.g. `fCXBPv48KNkm5oZq8UWdHG`) or the URL (e.g. `https://microreact.org/project/fCXBPv48KNkm5oZq8UWdHG`) of the project to be updated."
    },
    {
      "name": "name",
      "type": "text",
  ...
  "output": [
    ...
    },
    {
      "name": "url",
      "type": "url",
      "description": "The URL of the updated project."
    }
  ]
}